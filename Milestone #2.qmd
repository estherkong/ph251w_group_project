...
#This dataset is simulated, but approximates what population data from the State of California might look like. It includes population estimates for 2023 by CA county and demographic categories (age, race, and sex).
...
# Most variables are currently character fields, but to properly manipulate them, it will make sense to convert them to factors. eg. county, health_officer_region, age_cat, sex, and race.
