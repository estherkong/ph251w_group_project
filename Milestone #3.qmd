...
data_dictionary <- tribble(
  ...
  "cumulative_infected", "Cumulative infections to date", "numeric", "count", "Renamed from infected_cumulative",
  "new_severe", "Number of new severe infections", "numeric", "Count", "Renamed from severe_new",
  "cumulative_severe", "Cumulative severe infections to date", "numeric", "Count", "Renamed from severe_cumulative",
  # Population
  ...
  "severe_ratio_pct", "Severe-to-infection ratio", "numeric", "Percentage (%)", "Calculated as mean_severe / mean_infections *100"
)
